...
class MainCatalog extends Component  {
    constructor(props) {
      ...
      fetchAllRecords = () => {
        ...
        axios.get('/api/get', {timeout: 0}).then((response) => {
              this.setState({
        ...
        <div className="heades-section">
            ...
            <div className="tile-section">
                  <ul id="items_container"> {
                    this.state.loading ? <div class="spinner-border text-primary m-5" role="status"></div> : (this.state.records && this.state.records.map(record => {
                        return ( 
